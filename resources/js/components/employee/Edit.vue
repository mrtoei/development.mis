        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control " v-validate="'required'" name="birthday" v-model="birthday" id='datetimepicker'>
...
<script>
    ...
    export default {
        ...
        mounted(){
            axios.get('../api/users/'+this.id).then(
                (response)=>{
                 var user = response.data;
                    // console.log(response.data['0']);
                    // console.log(response.data['0'].birthday);
                    // console.log(response.data['em_id']);
                    this.emid=user['0'].em_id;
                    this.name=user['0'].first_name;
                    this.nickname=user['0'].nickname;
                    this.nationality=user['0'].nationality;
                    this.gender=user['0'].gender;
                    this.address=user['0'].street;
                    this.email=user['0'].email_private;
                    this.role=user['0'].role;
                    this.title=user['0'].title;
                    this.lastname=user['0'].last_name;
                    this.birthday=user['0'].birthday;
                    this.housenumber=user['0'].house_number;
                    this.postalcode=user['0'].postal_code; 
                }
            )
        }
    }
